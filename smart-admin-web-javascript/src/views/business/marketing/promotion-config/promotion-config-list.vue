...
<template>
    ...
    <a-form class="smart-query-form">
        <a-row class="smart-query-form-row">
            <a-form-item label="优惠配置名称，如：双11十元券兜底配置" class="smart-query-form-item">
                <a-input style="width: 200px" v-model:value="queryForm.promoName" placeholder="优惠配置名称，如：双11十元券兜底配置" />
            </a-form-item>
