  ...
  >
    <a-form ref="formRef" :model="form" :rules="rules" :label-col="{ span: 5 }" >
        ...
        <a-form-item label="该实例生效开始时间"  name="validStartTime">
          <a-date-picker show-time valueFormat="YYYY-MM-DD HH:mm:ss" v-model:value="form.validStartTime" style="width: 100%" placeholder="该实例生效开始时间" />
        </a-form-item>
        <a-form-item label="该实例失效过期时间"  name="validEndTime">
          <a-date-picker show-time valueFormat="YYYY-MM-DD HH:mm:ss" v-model:value="form.validEndTime" style="width: 100%" placeholder="该实例失效过期时间" />
        </a-form-item>
...
<script setup>
  ...
  import { taskRecordApi } from '/@/api/business/marketing/task-record/task-record-api';
