    ...
    <a-form class="smart-query-form">
        <a-row class="smart-query-form-row">
            ...
            <a-form-item label="【字典】任务分组：NEWBIE(新手), DAILY(日常), PROMO(大促), VIP(会员专属)" class="smart-query-form-item">
                <a-input style="width: 200px" v-model:value="queryForm.taskGroup" placeholder="【字典】任务分组：NEWBIE(新手), DAILY(日常), PROMO(大促), VIP(会员专属)" />
            </a-form-item>
            <a-form-item label="【字典】目标人群：ALL(全部), NEWMEMBER(新会员), OLDMEMBER(老会员)" class="smart-query-form-item">
                <a-input style="width: 200px" v-model:value="queryForm.targetAudience" placeholder="【字典】目标人群：ALL(全部), NEWMEMBER(新会员), OLDMEMBER(老会员)" />
            </a-form-item>
