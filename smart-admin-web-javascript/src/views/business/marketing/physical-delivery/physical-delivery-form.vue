...
<script setup>
  ...
  import { physicalDeliveryApi } from '/@/api/business/marketing/physical-delivery/physical-delivery-api';
  ...
  const rules = {
      ...
      status: [{ required: true, message: '【字典】状态：0-待发货, 1-已发货, 2-已签收, 3-异常退回 必填' }],
  };
